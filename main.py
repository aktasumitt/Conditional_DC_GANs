...
# Generator
Generator_Model=model.Generator(f_dim=config.F_DIM,channel_img=config.CHANNEL_IMG,num_classes=config.NUM_CLASSES,embed_size=config.NUM_EMBEDDING)
Generator_Model.to(devices)


# Discriminator
Discriminator_Model=model.Discriminator(channel_img=config.CHANNEL_IMG,num_classes=config.NUM_CLASSES,img_size=config.IMG_SIZE)
